      ...
      <div className="container">
        ...
        >
          {skills.map(({ img, title }, idx) => (
            <div
              className="p-4 md:p-8 bg-blue-100 border border-blue-400 rounded-md flex flex-col justify-center items-center gap-2 md:gap-5 duration-300 hover:scale-105 hover:bg-blue-400"
              key={idx}
            >
              <div
                className={`${
                  idx === 11
                    ? "w-72 h-72"
                    : "w-[50px] md:w-[80px] h-[50px] md:h-[80px]"
